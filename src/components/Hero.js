...
const Hero = () => {
  return (
    <div className="bg-[#ddd6fe] h-80">
      <div className="items-center justify-center lg:ml-80 md:ml-40 ml-10 py-7">
        ...
        <div className="lg:ml-60 md:ml-60 mt-5 ml-20">
        ...
        <div className="flex flex-row h-24 mt-5 px-10 ">
          ...
          <div className="bg-blue-300 lg:px-6 md:px-6 rounded-b-none rounded-xl">
            <h1 className="mt-4 lg:text-xl md:text-xl text-sm">
              Business and Ecommerce Plans
            </h1>
            <p className="text-sm">Essential for accepting online payments</p>
          </div>
        </div>
      </div>
    </div>
